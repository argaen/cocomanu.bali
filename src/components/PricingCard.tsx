...
export default function PricingCard({
  ...
  return (
    <div className="flex h-full w-full max-w-sm self-stretch flex-col bg-white-water text-black rounded-xl py-4 px-6 lg:px-12 mx-6 md:mx-0 intersect:animate-fade-up intersect-once">
